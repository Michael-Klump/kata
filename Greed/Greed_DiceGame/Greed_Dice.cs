...
namespace Greed_DiceGame
{
	...
	public class Greed_DiceGame
	{
        ...
        {
            if (DiceResultCount.ContainsKey(1) && DiceResultCount.ContainsKey(2) && DiceResultCount.ContainsKey(3)
                && DiceResultCount.ContainsKey(4) && DiceResultCount.ContainsKey(5) && DiceResultCount.ContainsKey(6))
            {
        ...
        {
            if (PossibleDiceResult == 1 && DiceResultCount.ContainsKey(PossibleDiceResult) && DiceResultCount[PossibleDiceResult] <= 2)
            {
                return POINTS_FOR_SINGLE_ONE * DiceResultCount[PossibleDiceResult];
            }
            else if (PossibleDiceResult == 5 && DiceResultCount.ContainsKey(PossibleDiceResult) && DiceResultCount[PossibleDiceResult] <= 2)
            {
